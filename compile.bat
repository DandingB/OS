...
i686-elf-gcc -ffreestanding -m32 -nostdlib -c -O0 "src\stdlib.c" -o "bin\stdlib.obj"
i686-elf-gcc -ffreestanding -m32 -nostdlib -c -O0 "src\memory.c" -o "bin\memory.obj"
...
i686-elf-ld -T linker.ld -nostdlib "bin\boot.obj" "bin\x86.obj" "bin\kernel.obj" "bin\stdio.obj" "bin\memory.obj" "bin\stdlib.obj" "bin\pci.obj" "bin\ahci.obj" "bin\xhci.obj" "bin\paging.obj" "bin\idt.obj" "bin\isr.obj" "bin\pic.obj" "bin\apic.obj" -o "bin\OS.bin" --oformat binary
