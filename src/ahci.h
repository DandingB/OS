...
#define HBA_PxCMD_ST    (1 << 0)	// Start (ST) bit in PxCMD register
#define HBA_PxCMD_FRE   (1 << 4)	// FIS Receive Enable (FRE) bit in PxCMD register
